  ...
  return (
    <>
      ...
      <div className="container-cr py-10">
        <div className="mx-auto max-w-md rounded-card border border-dashed border-ink-700 bg-ink-900/60 p-10 text-center">
          <span className="mx-auto grid size-12 place-items-center rounded-lg border border-ink-700 bg-ink-800 text-mist"><ShoppingBag className="size-6" /></span>
